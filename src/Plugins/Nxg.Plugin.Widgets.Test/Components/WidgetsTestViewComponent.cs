...
namespace Nxg.Plugin.Widgets.Test.Components
{
    public class WidgetsTestViewComponent : NopViewComponent
    {
        ...
        public WidgetsTestViewComponent(CurrencySettings currencySettings,
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            {
                await _logger.InsertLogAsync(Nop.Core.Domain.Logging.LogLevel.Error, "Error creating scripts for Google eCommerce tracking", ex.ToString());
            }
            return View("~/Plugins/Widgets.Test/Views/PublicInfo.cshtml", script);
        }
